...
import { OptimizerLabPanel } from "@/components/optimizer-lab-panel";
            ...
            <div className="flex h-screen items-center justify-center bg-transparent px-6">
                <div className="w-full max-w-md rounded-2xl border border-border/40 bg-card/40 p-6 text-center">
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">
                        Connect from the workspace to inspect pg_stats and live planner signals for your tables.
                    </p>
    ...
    return (
        <div className="min-h-screen bg-transparent text-foreground">
            <div className="pointer-events-none fixed inset-0 overflow-hidden">
                <div className="absolute -top-28 -right-28 h-80 w-80 rounded-full bg-cyan-500/5 blur-3xl" />
                ...
                <div className="mx-auto flex h-12 max-w-[1600px] items-center justify-between px-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-2">
                            <span className="bg-gradient-to-r from-cyan-400 to-teal-400 bg-clip-text text-sm font-bold text-transparent">
                                {APP_NAME}
                            </span>
                            <span className="hidden text-xs text-muted-foreground/80 sm:inline">Optimizer Lab</span>
                        </div>
                    </div>
                    <div className="flex items-center gap-2">
                        <Badge
