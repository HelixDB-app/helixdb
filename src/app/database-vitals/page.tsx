...
import { DatabaseVitalsPanel } from "@/components/database-vitals-panel";
...
export default function DatabaseVitalsPage() {
        ...
        return (
            <div className="flex h-screen items-center justify-center bg-transparent px-6">
                <div className="w-full max-w-md rounded-2xl border border-border/40 bg-card/40 p-6 text-center">
                    <HeartPulse className="mx-auto mb-3 h-10 w-10 text-muted-foreground/50" />
                    <h1 className="text-lg font-semibold">No active database connection</h1>
                    <p className="mt-2 text-sm text-muted-foreground">
                        Connect from the workspace to open Database Vitals for this server.
                    </p>
    ...
    return (
        <div className="min-h-screen bg-transparent text-foreground">
            <div className="pointer-events-none fixed inset-0 overflow-hidden">
                <div className="absolute -top-28 -right-28 h-80 w-80 rounded-full bg-emerald-500/5 blur-3xl" />
                <div className="absolute -bottom-32 -left-28 h-80 w-80 rounded-full bg-teal-500/5 blur-3xl" />
            </div>
                ...
                <div className="mx-auto flex h-12 max-w-[1600px] items-center justify-between px-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="hidden text-xs text-muted-foreground/80 sm:inline">Database Vitals</span>
                        </div>
                    </div>
                    <div className="flex items-center gap-2">
                        <Badge
            ...
            <main className="relative mx-auto max-w-[1600px] px-4 py-6">
                <DatabaseVitalsPanel connectionId={connectionId} />
            </main>
        </div>
    );
}
