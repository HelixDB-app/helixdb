...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::slow_query_ingest_from_pg_stat,
            commands::slow_query_snapshots_for_fingerprint,
            commands::slow_query_get_insight,
            commands::slow_query_save_explain_for_fingerprint,
            commands::slow_query_save_ai_for_fingerprint,
            commands::slow_query_save_note_for_fingerprint,
            commands::slow_query_set_pinned_for_fingerprint,
            commands::slow_query_list_pinned_fingerprints,
            commands::slow_query_list_trend_risks,
            commands::open_path,
